...
```
note use of aesthetics in scale_color_brewer, matchs the colors
...
Use the same manipulations as above, expect we will tag the results as male and female
...
Add the two data frames together and pivot wider
